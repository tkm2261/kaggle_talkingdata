...
LIST_COL = ['app', 'device', 'os', 'channel', 'hour',
            'avg_app', 'avg_device', 'avg_os', 'avg_channel', 'avg_day', 'avg_hour']
...
LIST_FLOAT_COL = ['avg_app', 'avg_device', 'avg_os', 'avg_channel', 'avg_day', 'avg_hour']
...
def get_lstm_sin(first_dences=[64, 64, 16],
    ...
    out = concatenate(one_hots + [floats] + [old_target], axis=2)
